...
import ${package}.domain.DtDefinitions;
 ...
 * @author jmforhan
 */
public class DtoTest extends Abstract${className}TestCase {
	...
	private <D extends DtObject, E extends DtFieldName> void verifierEnumfield(final D dto,
		...
		final String fdName = DtDefinitions.class.getCanonicalName() + "${symbol_dollar}" + dto.getClass().getSimpleName() + "Fields";
		try {
