 ...
 * @author jmforhan
 * @version ${symbol_dollar}Id: AbstractSearchTestCase.java 1326 2012-04-24 15:33:30Z npiedeloup ${symbol_dollar}
 */
public abstract class AbstractSearchTestCase<C extends DtObject, R extends DtObject> extends Abstract${className}TestCase {
